...
model = dict(
    type='CascadeRCNN',
    # Model Path of Razer Laptop
    # pretrained='/media/p/research/experiment/NAS/DARTSImp/PC-DARTS/checkpoints/eval-try-20200617-222258/model_best.pth.tar', # sonar pretrained
...
test_cfg = dict(
    rpn=dict(
        ...
        min_bbox_size=0),
    rcnn=dict(
        score_thr=0.000001, nms=dict(type='nms', iou_thr=0.5), max_per_img=100))
