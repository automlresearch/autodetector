model = dict(
    type='FasterRCNN',
    # pretrained='/media/p/research/experiment/NAS/DARTSImp/PC-DARTS/checkpoints/eval-try-20200617-222258/model_best.pth.tar',
    pretrained = '/media/p/research/experiment/NAS/DARTSImp/PC-DARTS/checkpoints/eval-try-20200620-002650/model_best.pth.tar',
    # pretrained='/media/p/research/experiment/NAS/DARTSImp/PC-DARTS/checkpoints/eval-try-20200617-222258/checkpoint.pth.tar',
